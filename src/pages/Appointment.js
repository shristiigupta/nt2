    ...
    <div className="appointment-wrapper">
      ...
      <div className="procedure-section">
        ...
        <ol className="procedure-list">
          ...
          <li>
            Patients are requested to plan the therapy sessions according to availability
          </li>
          <li>
          ...
          <li>
            Your appointment will be confirmed only after the payment is received. If the payment is not made within the blocking period, the appointment will not be considered confirmed and the time slot may be given to someone else.
          </li>
          <li>
